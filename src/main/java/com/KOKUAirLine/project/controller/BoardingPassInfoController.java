...
//    	Optional<FlightInfo> flight = repository.findFlightInfoByFlightNo("KE123");
    	
    	FlightInfo flight = flightInfoService.getFlightById("KE123");
        ...
        if (flight != null) {
            ...
            System.out.println("해당 항공편이 존재하지 않습니다.");
        }

        return "boardingPassInfo"; // boardingPassInfo.jsp 로 이동
    }
